...
public class SimpleAjpClient {
    ...
    static {
        AjpMessageTestHelper ajpCping = new AjpMessageTestHelper(16);
        ajpCping.reset();
     ...
     */
    public AjpMessageTestHelper createForwardMessage(String url) {
        AjpMessageTestHelper message = new AjpMessageTestHelper(AJP_PACKET_SIZE);
        message.reset();
     ...
     */
    public AjpMessageTestHelper sendMessage(AjpMessageTestHelper message)
            throws IOException {
        // Send the message
     ...
     */
    public AjpMessageTestHelper cping() throws IOException {
     ...
     */
    public AjpMessageTestHelper readMessage() throws IOException {
